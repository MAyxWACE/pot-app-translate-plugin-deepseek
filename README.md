...
| 等级 | 名称 | Token消耗 | 适用场景 | 输出内容 |
|------|------|----------|----------|----------|
| **等级1** | 基础翻译 | ⭐ 最低 | 快速翻译、Token有限 | 仅翻译结果，无额外信息 |
| **等级2** | 标准翻译 | ⭐⭐ 较低 | 日常使用 | 单词：释义 + 变形 + 1个例句<br>词组：所有释义<br>句子：直接翻译 |
| **等级3** | 详细翻译 | ⭐⭐⭐ 中等 | 学习研究 | 单词：释义 + 变形 + 3-5个同根词 + 2个例句<br>词组：所有释义 + 2个例句<br>句子：直接翻译 |
| **等级4** | 完整翻译 | ⭐⭐⭐⭐ 最高 | 深度学习 | 单词：释义 + 变形 + 3-5个同根词 + 3-5个搭配 + 2-3个例句<br>词组：所有释义 + 2-3个例句<br>句子：直接翻译 |
